...
if len(args) < 3 or len(args) % 2 != 1:
    print('Modo de uso:\nlinear_hyp_test.py [nombre_dataset] [path_dataframe.csv]')
...
ESTIMATOR = RegressorChain(base_estimator=LinearRegression(), random_state=RAND_STATE)
HYPER_SPACE = { 'base_estimator__fit_intercept': [True, False] }
