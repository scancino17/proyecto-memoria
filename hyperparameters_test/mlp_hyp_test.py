...
if len(args) < 3 or len(args) % 2 != 1:
    print('Modo de uso:\nmlp_hyp_test.py [nombre_dataset] [path_dataframe.csv]')
    ...
    print('  "--max_iter": Cantidad máxima de iteraciones para el entrenamiento de cada modelo. Por defecto 1000')
    sys.exit(0)
...
ESTIMATOR_NAME = 'MLP'
ESTIMATOR = MLPRegressor(max_iter=1000, random_state=RAND_STATE)
HYPER_SPACE = {
