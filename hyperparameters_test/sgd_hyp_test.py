...
if len(args) < 3 or len(args) % 2 != 1:
    print('Modo de uso:\nsgd_hyp_test.py [nombre_dataset] [path_dataframe.csv]')
...
ESTIMATOR_NAME = 'SGD'
ESTIMATOR = RegressorChain(base_estimator=SGDRegressor(max_iter=MAX_ITER, random_state=RAND_STATE), random_state=RAND_STATE)
HYPER_SPACE = {
