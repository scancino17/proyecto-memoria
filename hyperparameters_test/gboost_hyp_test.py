...
if len(args) < 3 or len(args) % 2 != 1:
    print('Modo de uso:\ngboost_hyp_test.py [nombre_dataset] [path_dataframe.csv]')
...
ESTIMATOR = RegressorChain(base_estimator=GradientBoostingRegressor(random_state=RAND_STATE), random_state=RAND_STATE)
HYPER_SPACE = {
